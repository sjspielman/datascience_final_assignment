...
# UI --------------------------------
ui <- shinyUI(
        navbarPage( theme = shinytheme("cerulean"), ### Uncomment the theme and choose your own favorite theme from these options: https://rstudio.github.io/shinythemes/
